###################################################################################################
#R conversion of the DEB tool alga sgr2.m function (DEBtool package ?V scripts freely available (https://www.bio.vu.nl/thb/deb/deblab/debtool/DEBtool_M/manual/index.html))
...
SolveR_R <- function(m_E, k_E, J_EM, y_EV, J_VM, r0){
  ...
  n <- 50 #max of interations was set at 20
  ...
  #this while loop continues to run while the number of iterations is less than n and for the function f: f^2 > 1e-15
